...
public class HandlerPdfDB implements RequestHandler<S3Event, String> {
  Gson gson = new GsonBuilder().setPrettyPrinting().create();
  private static final Logger logger = LoggerFactory.getLogger(HandlerPdfDB.class);
  ...
  public String insert(String pdfinfo) {

	  logger.info("Successfully executed query : " + pdfinfo);
	  ...
	  try {
	      ...
	      logger.info("Successfully executed query.  Result: " + currentTime);
